...
async def reply(message: types.Message):
    ...
    prompt_system = "تو یه دوست صمیمی و مهربون هستی که لحن حرف زدنت دخترونه، دلنشین و خیلی مهربونه..."
    ...
    if response.status_code == 200:
        ...
        await message.answer("آخی عزیز دلم! یه مشکلی پیش اومده… ولی من اینجام کنارت ❤️")
